...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row f">
		...
		<?php echo $form->dropDownList($model,'birth_place',array('Abra',
'Agusan del Norte',
'Agusan del Sur',
'Aklan',
'Albay',
...
'Zamboanga Sibugay','Abroad')); ?>
	...
	<div class="row f">
		...
		<?php echo $form->dropDownList($model,'barangay',array('Anos' => 'Anos','Bagong Silang' => 'Bagong Silang','Bambang' => 'Bambang','Batong Malake' => 'Batong Malake','Baybayin' => 'Baybayin','Bayog' => 'Bayog','Lalakay' => 'Lalakay','Maahas' => 'Maahas','Malinta' => 'Malinta','Mayondon' => 'Mayondon','Putho' => 'Putho','San Antonio' => 'San Antonio','Tadlak' => 'Tadlak','Timugan' => 'Timugan')); ?>
		<?php echo $form->error($model,'barangay'); ?>
	</div>

	<div class="row f">
		<?php echo $form->labelEx($model,'years_of_residency'); ?>
		<?php echo $form->numberField($model,'years_of_residency'); ?>
	...
	<div class="row f">
		...
		<?php echo $form->dropDownList($model,'civil_status',array('Single'=>'Single','Married'=>'Married','Widowed'=>'Widowed','Separated'=>'Separated')); ?>
	...
	<div class="row f">
		...
		<?php echo $form->numberField($model,'spouse_age'); ?>
		<?php echo $form->error($model,'spouse_age'); ?>
	</div>

	<div class="row f">
		<?php echo $form->labelEx($model,'educ_attainment'); ?>
		<?php echo $form->dropDownList($model,'educ_attainment',array('Elementary Undergraduate' => 'Elementary Undergraduate','Elementary Graduate' => 'Elementary Graduate','Highschool Undergraduate' => 'Highschool Undergraduate','Highschool Graduate' => 'Highschool Graduate','College Undergraduate' => 'College Undergraduate','College Graduate' => 'College Graduate','Post-Graduate' => 'Post-Graduate')); ?>
		<?php echo $form->error($model,'educ_attainment'); ?>
	</div>

	<div class="row f">
		<?php echo $form->labelEx($model,'work_xp'); ?>
		<?php echo $form->textArea($model,'work_xp'); ?>
		<?php echo $form->error($model,'work_xp'); ?>
	</div>

	<div class="row f">
		<?php echo $form->labelEx($model,'employed'); ?>
		<?php echo $form->dropDownList($model,'employed',array('Yes'=>'Yes','No'=>'No')); ?>
	...
	<div class="row f">
		...
		<?php echo $form->numberField($model,'monthly_salary'); ?>
	...
	<div class="row f">
		...
		<?php echo $form->dropDownList($model,'philhealth_member',array('Yes'=>'Yes','No'=>'No')); ?>
	...
	<div class="row f">
		...
		<?php echo $form->dropDownList($model,'philhealth_dependent',array('Yes'=>'Yes','No'=>'No')); ?>
